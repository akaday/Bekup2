...
public class ListPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String brand    =  ambil.getStringExtra("brand");

        phoneList = new ArrayList<Phone>();
        new JSONAsyncTask().execute("http://ibacor.com/api/gsm-arena?view=brand&slug="+brand+"&page=1");

        ListView listview = (ListView) findViewById(R.id.lv_item);
        adapter = new PhoneAdapter(ListPhone.this, R.layout.lsv_item_phone, phoneList);
...
//                Log.d("KODENYA" , kodeslug);
                Intent pindah = new Intent(ListPhone.this, DetailPhone.class);
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(ListPhone.this);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if(result == false)
                Toast.makeText(ListPhone.this, "Unable to fetch data from server", Toast.LENGTH_LONG).show();
